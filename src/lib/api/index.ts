...
export const filmListQuery = async (currentPage: string, pageSize: string, term: string, genre : string) => {
  ...
  }>(`list_movies.json?page=${currentPage}&limit=${pageSize}&query_term=${term}&genre=${genre}`);
